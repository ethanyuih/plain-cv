  ...
  experienceList: [
    {
      ...
      companyComment: "ByteCloud Infrastructure Team",
      ...
      titles: [
        {
          ...
          taskList: [
            "Responsible for internal database architecture design and optimization for MySQL and ByteNDB, providing stable database infrastructure support for applications including TikTok, CapCut, and Toutiao serving tens of millions of users.",
            ...
            "Developed RESTful API interfaces for the ByteCloud platform using Python Django and Go with ByteGorm. ",
