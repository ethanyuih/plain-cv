      ...
      titles: [
        {
          ...
          taskList: [
            ...
            'Designed and implemented multi-tenant database architecture using PostgreSQL and Spring Data JPA, with Hibernate as ORM provider and custom tenant resolver for dynamic data source routing.',
            'Utilized Spring Security with OAuth2 for secure authentication and JWT for stateless authorization, implementing role-based access control (RBAC) with interceptors for request authorization, improving application security by 35%.',
