      ...
      titles: [
        {
          ...
          taskList: [
            ...
            "Built and deployed high-performance RESTful API endpoints for our CRM on AWS EC2 using Spring Boot 3.0 with Java 17, leveraging Spring Cache and Redis for optimization, achieving a 500% improvement in API response time.",
        ...
        },
        {
          ...
          taskList: [
            ...
            "Built and maintained third party payment integrations, preventing duplicate transactions through Redis-based distributed locking, achieving 99.99% processing accuracy.",
            // "Spearheaded ChatGPT API implementation across core business applications, driving 20% increase in user satisfaction through enhanced automation.",
            "Utilized Spring Batch and Quartz for background jobs (reports, emails), achieving 60% reduction in server load.",
