      ...
      titles: [
        {
          ...
          taskList: [
            ...
            "Designed and Built a central API Gateway, centralizing WebSocket channel management and integrating ETCD for service discovery across HTTP and gRPC endpoints.",
            "Engineered custom authentication service using Go-OAuth2 and JWT tokens, implementing role-based access control (RBAC) with middleware for secure inter-service authorization.",
