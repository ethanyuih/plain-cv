      ...
      titles: [
        {
          ...
          taskList: [
            ...
            "Led the decomposition of monolithic application into microservices on Kubernetes, reducing deployment time by 70%.",
        ...
        },
        {
          ...
          taskList: [
            ...
            "Engineered real-time trade monitoring system with .NET Core, leveraging AWS SQS and Kafka for distributed message processing, achieving 100K messages/second throughput and sub-50ms trading feedback latency.",
            "Built and maintained third party payment integrations, preventing duplicate transactions through Redis-based distributed locking, achieving 99.99% processing accuracy.",
            // "Spearheaded ChatGPT API implementation across core business applications, driving 20% increase in user satisfaction through enhanced automation.",
            // "Utilized Hangfire for background jobs (reports, emails), achieving 60% reduction in server load.",

            "Collaborated with a team of 5 to develop a CRM frontend application using Vue 3 with TypeScript.",
